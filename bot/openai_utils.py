...
class ChatGPT:
    ...
    def _count_tokens_from_messages(self, messages, answer, model="gpt-3.5-turbo"):
        ...
        # default token settings for all models
...
async def transcribe_audio(audio_file) -> str:
    try:
        ...
        logger.error(f"Ovozli xabar transkripsiya xatosi: {e}")
        return "⚠️ Ovozli xabarni tanib bo'lmadi. Groq API ovozli xabarlarni qo'llab-quvvatlamaydi."


async def generate_images(prompt, n_images=4, size="512x512"):
    raise ValueError("⚠️ Rasm yaratish Groq API'da qo'llab-quvvatlanmaydi. Boshqa rejimni tanlang.")
